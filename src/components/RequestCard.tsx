...
export default function RequestCard({ request }: RequestCardProps) {
  return (
    <Card variant="elevated" className={styles.requestCard}>
      <Box className={styles.cardContent}>
        ...
        {/* Title */}
        <Heading className={styles.title}>{request.title}</Heading>
        ...
        <div className={styles.detailsGrid}>
          ...
          <div className={styles.detailRow}>
            <div className={styles.detailItem}>
              ...
              <Text className={styles.detailText}>Qty: {request.quantity}</Text>
            </div>
          ...
          <div className={styles.locationSection}>
            <Text className={styles.locationValue}>{request.sourceCity}</Text>
            <div className={styles.locationLine}></div>
            <Text className={styles.locationValue}>{request.deliveryCity}</Text>
          </div>
